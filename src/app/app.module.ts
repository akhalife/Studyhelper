...
const cookieConfig: NgcCookieConsentConfig = {
  cookie: {
    domain: 'Quiz-env.eba-kmnkfjnz.eu-central-1.elasticbeanstalk.com', // or 'your.domain.com' // it is mandatory to set a domain, for cookies to work properly (see https://goo.gl/S2Hy2A)
  },
  palette: {
    popup: {
      background: '#000',
